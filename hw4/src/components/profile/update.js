...
export const UpdateItem = ({inputtype, id, placeholderText, label, pattern, reference}) => {
    return (
        <div className="form-group">
            ...
            <div className="col-sm-6">
                ...
                placeholder={placeholderText} pattern={pattern}>
                </input>
            </div>
        </div>
    )
    ...
    const _update = (event) => {
     ...
     <div>
        <form name="accountRegisteration" className="form-horizontal col-sm-6" id="signOnForm" action="#">
            ...
            placeholderText="e.g. 713-333-3333" label="Phone Number:"/>
...
const mapStateToProps = (state) => ({ profile: state.profile.profiles[0]});
