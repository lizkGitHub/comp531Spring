...
const Register = ({ signOn }) => {
    ...
    return(
        <form name="accountRegisteration" className="form-horizontal" id="signOnForm" onSubmit={ signOn }>
            ...
            <RegisterLine labelName="UserName:" inputType="text" inputName="accountNameRG" 
            ...
            <RegisterLine labelName="Display name:" inputType="text" inputName="displayNameRG" 
                inputPattern='^.*$' inputPlaceholder="(Optional) displayname"
                inputTitle="" mustRequired={false} />
            <RegisterLine labelName="Email address:" inputType="email" inputName="emailAddrRG" inputPattern='^.*$' 
                inputPlaceholder="Please enter an email address"
                inputTitle="" mustRequired={true} />
            <RegisterLine labelName="Phone Number:" inputType="text" inputName="phoneNumberRG" 
            ...
            <RegisterLine labelName="Date of Birth:" inputType="date" inputName="dateOfBirthRG" inputPattern='^.*$' 
            ...
            <RegisterLine labelName="Zip code:" inputType="text" inputName="zipCodeRG" inputPattern='^\d{5}$'
                inputPlaceholder="e.g. 77030"
                inputTitle="5 digit number e.g. 77030" mustRequired={true} />
            <RegisterLine labelName="Password:" inputType="password" inputName="passwordRG" inputPattern='^.*$' 
                inputPlaceholder="Please set an password"
                inputTitle="" mustRequired={true} />
            <RegisterLine labelName="Confirm Password:" inputType="password" inputName="passwordConfRG" 
                inputPattern='^.*$' inputPlaceholder="Please re-enter the password "
                inputTitle="" mustRequired={true} />
            <div><InfoSignOn id="signOnInfo"/></div>
