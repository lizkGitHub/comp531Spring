...
const logIn = (state = { hasErrorLogIn: null, errMsg:"", authenticated: false, authType: {}, normalUser: false }, action) => {
    switch(action.type) {
    	case 'normalLogin':
    		return {
				...state, 
	    ...
	    case 'normalLogout':
			return {  ...state, hasErrorLogIn: false, authenticated: false, errMsg:"", normalUser: false};
		case 'authType':
			return {...state, authType: action.data}
		default:
	    	return state;
	}
}
